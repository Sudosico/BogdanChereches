    ...
    <AnimatePresence>
      {visible && (
        <motion.div
          ...
          className="fixed right-4 bottom-8 z-50 hidden md:flex flex-col gap-3"
        >
          <a
            href={waLink()}
            target="_blank"
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="w-14 h-14 rounded-full bg-gradient-to-br from-[#0088FF] to-[#00C6FF] text-white flex items-center justify-center shadow-lg shadow-[#0088FF]/30 hover:scale-110 transition-transform duration-300"
