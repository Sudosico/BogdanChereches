...
import { CONTACT, LOCATIONS, waLink } from "@/lib/constants";
    ...
    <>
      ...
      <main>
        <SubpageHero
          ...
          description="Programează o ședință de Terapie Bowen prin WhatsApp, Messenger sau telefon."
        />
        ...
        <SectionWrapper>
          <ScrollReveal className="text-center mb-14">
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Alege metoda preferată și scrie-i lui Bogdan direct.
            </p>
          </ScrollReveal>
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto mb-16">
            <ScrollReveal>
              <div className="bg-white rounded-2xl p-6 border border-border/50 text-center h-full">
                ...
                <p className="text-muted-foreground text-sm mb-4">
                  Cel mai rapid mod de a programa o ședință.
                </p>
                <CTAButton
                  href={waLink()}
            ...
            <ScrollReveal delay={0.1}>
              <div className="bg-white rounded-2xl p-6 border border-border/50 text-center h-full">
                ...
                <p className="text-muted-foreground text-sm mb-4">
                  Scrie direct pe Facebook Messenger.
                </p>
                <CTAButton
                  href={CONTACT.messenger}
                  label="Deschide Messenger"
                  variant="messenger"
                  size="sm"
                  className="w-full"
                />
                  ...
                  <div className="p-6">
                    ...
                    {loc.mapLink ? (
                      <a
                        ...
                        className="flex items-start gap-2 text-muted-foreground mb-3 hover:text-sage transition-colors group"
                      >
                    ...
                    <div className="flex items-start gap-2 text-muted-foreground mb-5">
                      ...
                      <span className="text-sm">
                        Cu programare, contactează pentru disponibilitate
                      </span>
                    </div>
                    <CTAButton
                      href={waLink()}
